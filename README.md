...
### Option A: RunPod (Cloud GPU - Recommended for Remote Access)

**Deploy directly to RunPod with pre-built Docker image:**
...
# 2. Run template creator (interactive mode)
./template.sh

# 3. Upload generated template to RunPod
...
**What you get:**
- Pre-configured template with GPU access
- Automatic port forwarding (port 6969)
- Persistent storage for models and datasets
- Optional password protection for Web UI
- Access via: `http://[pod-id]-6969.proxy.runpod.net`

**Recommended GPU:** RTX 4090 (24GB) or RTX 5090 (32GB)
**Storage:** 100GB container disk + 50GB persistent volume (configurable)

See `RUNPOD_USAGE.md` (generated by template.sh) for detailed instructions.

---

### Option B: Local Docker (Requires Local GPU)
